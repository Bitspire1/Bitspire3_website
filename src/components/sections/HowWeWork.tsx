...
const HowWeWork: React.FC<HowWeWorkProps> = ({ data }) => {
  ...
  return (
    <section className="py-24 px-4 bg-slate-900/20 relative overflow-hidden" id="how-we-work">
      ...
      <div className="container mx-auto max-w-6xl relative z-10">
        ...
        <div className="mt-16 text-center">
          <div className="glass-panel rounded-2xl p-8 max-w-2xl mx-auto border border-blue-500/20">
