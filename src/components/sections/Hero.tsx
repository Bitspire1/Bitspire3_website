...
export const Hero: React.FC<{ data?: HeroData }> = ({ data }) => {
  ...
  return (
    <section className="relative py-20 lg:py-32 overflow-hidden">
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[1000px] h-[500px] bg-blue-500/10 blur-[100px] rounded-full pointer-events-none mix-blend-screen" />
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[400px] bg-cyan-500/10 blur-[80px] rounded-full pointer-events-none mix-blend-screen animate-pulse" />
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="text-center lg:text-left relative z-20">
            ...
            <h1 className="text-5xl lg:text-7xl font-bold text-white mb-8 leading-tight tracking-tight drop-shadow-lg">
              ...
              {' '}
              <span className="text-transparent bg-clip-text bg-linear-to-r from-blue-400 via-cyan-400 to-blue-400 animate-gradient-x block mt-2 pb-2" data-tina-field={tinaField(data, 'titleAccent')}>
                {titleAccent || 'Enter accent...'}
              </span>
              <span data-tina-field={tinaField(data, 'titleEnd')}>
                {titleEnd || 'Enter ending...'}
              </span>
            </h1>
          ...
          <div className="relative lg:h-[600px] flex items-center justify-center perspective-1000">
            {image ? (
              <div className="relative w-full h-full animate-float preserve-3d">
                 ...
                 <div className="absolute inset-0 bg-linear-to-tr from-blue-500/10 to-cyan-500/10 rounded-3xl blur-3xl -z-10" />
                 <Image
                   src={image}
