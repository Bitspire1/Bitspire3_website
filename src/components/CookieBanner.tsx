    ...
    <>
      ...
      >
        ...
        <p className="text-sm text-slate-300 leading-relaxed mb-4">
          ...
          działanie serwisu. Szczegóły znajdziesz w <a href="/polityka-prywatnosci/" className="text-blue-400 underline">polityce prywatności</a> i <a href="/polityka-cookies/" className="text-blue-400 underline">polityce cookies</a>.
        </p>
